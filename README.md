...
{
	Lcd_cursor(&lcd,0,1);
	Lcd_string(&lcd,"Name:Ashwin Akash M\n");
	Lcd_cursor(&lcd,1,1);
	Lcd_string(&lcd,"Reg.No: 212223230024\n");
}
```


## Output screen shots of proteus  :
 ![image](https://github.com/user-attachments/assets/c9228ec5-8ce7-4a5b-9480-e0fdc5e84f13)


 
## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 
 ![EX-3](https://github.com/user-attachments/assets/33295fc7-4702-4935-bf2f-b64e1c0d8c03)
